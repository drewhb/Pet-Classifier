...
% Extra Competition
% [trainedClassifier, validationAccuracy] = trainClassifier_1(Xtrain, ytrain);
% yfit = trainedClassifier.predictFcn(Xtest); 
% test_error = error_rate(yfit, ytest); 
% e = sprintf('Cosine KNN test error rate is %.4g%%.',test_error);
% disp(e); 